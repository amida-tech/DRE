...
function reconcile(username, newObject, baseObject, newRecordID, callback) {
    ...
    function splitNewPartialEntries(match, newObjectArray, originalNewObjectArray, baseObjectArray) {
        ...
        //console.log("newObjectArray " + JSON.stringify(newObjectArray, null, 2));
        //console.log("originalNewObjectArray " + JSON.stringify(originalNewObjectArray, null, 2));
        //console.log("baseObjectArray " + JSON.stringify(baseObjectArray, null, 2));
        //console.log("newObjectArray " + newObjectArray.organizations.length);
        console.log("originalNewObjectArray " + originalNewObjectArray.organizations.length);
        console.log("baseObjectArray " + baseObjectArray.organizations.length);
