...
var cases_c = require('test/artifacts/fhir/fixtures/unit/condition');
var cases_ma = require('test/artifacts/fhir/fixtures/unit/medicationAdministration');
var cases_mp = require('test/artifacts/fhir/fixtures/unit/medicationPrescription');
var cases_ors = require('test/artifacts/fhir/fixtures/unit/observation-result-single');
var cases_or = require('test/artifacts/fhir/fixtures/unit/observation-result');
var cases_ov = require('test/artifacts/fhir/fixtures/unit/observation-vital');
var cases_p = require('test/artifacts/fhir/fixtures/unit/patient');
