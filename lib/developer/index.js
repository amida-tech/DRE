...
// user roles
app.get('/api/v1/admin', roles.can('access admin page'), function (req, res) {
    // console.log(res);
    // console.log(req.user.role);
    res.sendStatus(true);
});
app.get('/api/v1/developer/home', roles.can('access developer page'), function (req, res) {
    // console.log(res);
    // console.log(req.user.role);
    res.sendStatus(true);
});
...
app.post('/api/v1/developer/changepassword', roles.can('access developer page'), function (req, res) {
...
app.post('/api/v1/developer/login',
...
//logout
app.get('/api/v1/developer/logout', function (req, res) {
    req.logout();
    res.status(200).end();
});
