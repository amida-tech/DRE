...
module.exports.authorization = [
    ...
    function (req, res, next) {
        if (req.user) {
            ...
            res.redirect('/#/oauth2?redirectUri=' + encodeURIComponent(req.url) + "&clientId=" + encodeURIComponent(req.query.client_id) + "&responseType="  + encodeURIComponent(req.query.response_type));
        }
    },
...
module.exports.register = function (req, res, next){
        clients.findByClientName( req.body.client_name, function(err, client) {
            ...
            if(client) {
                return res.status(400).send({error: client.clientName +  ' already registered!'});
            }
