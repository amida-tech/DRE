...
app.put('/api/v1/record/demographics', login.checkAuth, function(req, res) {
    console.log("posting", req.body);
    function updateProf(inputInfo) {
        var info = { name: inputInfo.middleName
            // "name": {
        ...
        console.log(info, req.username);
        record.updateEntry('demographics', req.username, info, function(err) {
            if (err) {
                throw err;
            } else {
