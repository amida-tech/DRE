describe('angularjs homepage', function() {
    ...
    it('upload bb03', function() {        
        uploadTest();
        //browser.pause();
    });
    
    it('continue bb03 upload', function() {        
        continueUpload();
        //browser.pause();
    });
    
    it('confirm bb03 upload', function() {        
        confirmUpload();
        //browser.pause();
    });   
    
    
    it('go to record page after bb03 upload', function() {        
        gotoRecord();
        recordTimeline();
        //browser.pause();
    });    
