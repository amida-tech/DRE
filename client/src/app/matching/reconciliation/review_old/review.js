...
angular.module('dre.match.review_old', [])

.config(['$routeProvider',
    function($routeProvider) {
        $routeProvider.when('/match/reconciliation/review_old', {
            templateUrl: 'templates/matching/reconciliation/review_old/review.tpl.html',
            controller: 'reviewCtrl'
        });

        $routeProvider.when('/match/reconciliation/review_old/:section/:index/:src_id/:dest_id', {
            templateUrl: 'templates/matching/reconciliation/review_old/review.tpl.html',
            controller: 'reviewCtrl'
        });
...
.controller('reviewCtrl', ['$scope', '$http', '$location', '$route', '$routeParams', '$rootScope', 'recordFunctions',
    function($scope, $http, $location, $route, $routeParams, $rootScope, recordFunctions) {
        ...
        $scope.dynamicTemplatePath = "templates/matching/reconciliation/review_old/components/"+$scope.section+".tpl.html";
