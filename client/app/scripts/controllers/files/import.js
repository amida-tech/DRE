...
FilesImport.$inject = ['$location', '$route', 'importService', '$http', 'format', 'record', 'dataservice'];

function FilesImport($location, $route, importService, $http, format, record, dataservice) {
