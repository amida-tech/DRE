...
exec 3< <(DBname=devtests ./node_modules/.bin/istanbul cover server.js --dir ./test/coverage --handle-sigint & echo $! >test/coverage/pid)
...
# run tests
DBname=devtests grunt mochaTest
