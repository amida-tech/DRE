...
describe('Pre Test Cleanup', function () {
    ...
    it('Remove Social Collections', function (done) {
        common.removeCollection('social_histories', function (err) {
            if (err) {
                done(err);
            }
            common.removeCollection('social_historymerges', function (err) {
                if (err) {
                    done(err);
                }
                common.removeCollection('social_historymatches', function (err) {
                    if (err) {
                        done(err);
                    }
