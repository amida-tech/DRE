...
describe('Pre Test Cleanup', function () {
    ...
    it('Remove Medication Collections', function (done) {
        common.removeCollection('medications', function (err) {
            if (err) {
                done(err);
            }
            common.removeCollection('medicationsmerges', function (err) {
                if (err) {
                    done(err);
                }
                common.removeCollection('medicationsmatches', function (err) {
                    if (err) {
                        done(err);
                    }
